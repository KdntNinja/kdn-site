<script lang="ts">
    ...
    import * as Drawer from "$lib/components/new-york/ui/drawer/index.js";
...
<div class="grid h-screen w-full pl-[53px]">
    <aside class="inset-y fixed left-0 z-20 flex h-full flex-col border-r">
        ...
        <nav class="grid gap-1 p-2">
            ...
            <Tooltip.Root>
                <Tooltip.Trigger asChild let:builder>
                    <Button variant="ghost" size="icon" class="rounded-lg" aria-label="Models" builders="{[builder]}">
                        <Bot class="size-5" />
                    </Button>
                </Tooltip.Trigger>
            ...
            <Tooltip.Root>
                <Tooltip.Trigger asChild let:builder>
                    <Button variant="ghost" size="icon" class="rounded-lg" aria-label="API" builders="{[builder]}">
            ...
            <Tooltip.Root>
                <Tooltip.Trigger asChild let:builder>
                    <Button variant="ghost" size="icon" class="rounded-lg" aria-label="Settings" builders="{[builder]}">
