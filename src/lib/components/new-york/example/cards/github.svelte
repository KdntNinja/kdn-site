...
<Card.Root>
    <Card.Header class="grid grid-cols-[1fr_110px] items-start gap-4 space-y-0">
        <div class="space-y-1">
            ...
            <Card.Description>Beautifully designed components built with Radix UI and Tailwind CSS.</Card.Description>
        </div>
        <div class="flex items-center space-x-1 rounded-md bg-secondary text-secondary-foreground">
            ...
            <DropdownMenu.Root>
                ...
                <DropdownMenu.Content class="w-[200px]" align="end">
                    ...
                    <DropdownMenu.CheckboxItem bind:checked="{futureIdeas}">Future Ideas</DropdownMenu.CheckboxItem>
                    <DropdownMenu.CheckboxItem bind:checked="{myStack}">My Stack</DropdownMenu.CheckboxItem>
                    <DropdownMenu.CheckboxItem bind:checked="{inspiration}">Inspiration</DropdownMenu.CheckboxItem>
                    <DropdownMenu.Separator />
                    <DropdownMenu.Item>
