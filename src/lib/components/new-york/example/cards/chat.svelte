<script lang="ts">
    ...
    import * as Avatar from "$lib/components/new-york/ui/avatar/index.js";
    import * as Card from "$lib/components/new-york/ui/card/index.js";
    import * as Command from "$lib/components/new-york/ui/command/index.js";
    import * as Dialog from "$lib/components/new-york/ui/dialog/index.js";
    ...
    <Card.Header class="flex flex-row items-center">
        ...
        <Tooltip.Root openDelay="{0}">
            <Tooltip.Trigger asChild>
                <Button size="icon" variant="outline" class="ml-auto rounded-full" on:click="{() => (open = true)}">
                    <Plus class="h-4 w-4" />
...
<Dialog.Root bind:open>
    <Dialog.Content class="gap-0 p-0 outline-none">
        <Dialog.Header class="px-4 pb-4 pt-5">
            ...
            <Dialog.Description>Invite a user to this thread. This will create a new group message.</Dialog.Description>
        </Dialog.Header>
        ...
        <Dialog.Footer class="flex items-center border-t p-4 sm:justify-between">
            ...
            {/if}
            <Button disabled="{selectedUsers.length < 2}" on:click="{() => (open = false)}">Continue</Button>
        </Dialog.Footer>
    </Dialog.Content>
</Dialog.Root>
